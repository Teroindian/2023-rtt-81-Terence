...
public class HibernateExample {
	...
	//	Order order = orderDao.findById(10106);
		
	//	System.out.println(order.getId() + " | " + order.getCustomerId());
		
	//			System.out.println(order.getId() + order.getCustomerId()+ " | " + " | " + order.getOrderDate()  + " | " + " | " +order.getRequiredDate()
	//	 + " | "+ order.getStatus());
...
//		System.out.println(orderdetail.getId() + " | " + orderdetail.getProductId());
