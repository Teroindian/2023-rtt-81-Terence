...
public class Question1 {
	...
	public static void main(String[] args) {
	 ...
	 public  List<String> filterArray() {
	        ...
	        System.out.println("here is newlist " + newList);
	        return newList;
	...
	void run( ) {  
		...
		// Initialize the array so that all elements have the value "ten"
		for (int i = 0; i < array.length; i++) {
			array[i] = "ten";
		}

		// Copy all of the values from the array into the list and print the message
		List<String> list = new ArrayList<>();
		for (int i = 0; i < array.length; i++) {
			list.add(array[i]);
			System.out.println("I have added " + array[i] + " at position " + i);
		}
